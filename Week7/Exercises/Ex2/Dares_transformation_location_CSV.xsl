...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p><xd:b>Created on:</xd:b> 15 Jun 15 2019.</xd:p>
            <xd:p><xd:b>Author:</xd:b> Katarzyna Anna Kapitan</xd:p>
            <xd:p>Stylesheet for the ESU DH course Manuscripts in the Digital Age. 
                It converts TEI-XML with listPlace into a CSV file which can be used as an input file for for Google MyMaps.</xd:p>
        </xd:desc>
    </xd:doc>
